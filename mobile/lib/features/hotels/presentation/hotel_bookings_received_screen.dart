...
class HotelBookingsReceivedScreen extends ConsumerWidget {
  const HotelBookingsReceivedScreen({super.key, required this.hotelId});

  final String hotelId;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final bookingsAsync = ref.watch(hotelBookingsReceivedProvider(hotelId));
              ...
              child: Column(
                ...
                children: [
                  ...
                  AppButton(
                    ...
                    expand: false,
                    onPressed: () => ref.invalidate(hotelBookingsReceivedProvider(hotelId)),
                  ),
                ],
              ),
            ),
